...
func (r *reportable) ServerReporter(ctx context.Context, req interface{}, typ interceptors.GRPCType, service string, method string) (interceptors.Reporter, context.Context) {
	reqLoggerDecider := r.requestLoggerDecision(ctx, interceptors.FullMethod(service, method), req)
...
func (r *reportable) ClientReporter(ctx context.Context, resp interface{}, typ interceptors.GRPCType, service string, method string) (interceptors.Reporter, context.Context) {
	reqLoggerDecider := r.requestLoggerDecision(ctx, interceptors.FullMethod(service, method), resp)
	return r.reporter(ctx, typ, service, method, KindClientFieldValue, reqLoggerDecider)
}

func (r *reportable) reporter(ctx context.Context, typ interceptors.GRPCType, service string, method string, kind string, requestLoggerDecision bool) (interceptors.Reporter, context.Context) {
	...
	return &reporter{
		...
		service:               service,
		method:                method,
		requestLoggerDecision: requestLoggerDecision,
		opts:                  r.opts,
