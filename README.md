...
* One of the most powerful interceptor was imported from https://github.com/grpc-ecosystem/go-grpc-prometheus (repo is now deprecated). This consolidation allows easier maintenance, easier use and consistent API. **No metric name or label changed**, so all your dashboards, alerts and integrations should be unaffected by the migration.
