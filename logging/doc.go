...
Once the gRPC logging middleware has added the gRPC specific Tags to the ctx (the tags intercepter must be set up) they will then be written with the logs
