...
var (
	...
	customServerMetrics *ServerMetrics = NewServerMetrics(prometheus.DefaultRegisterer)
)
...
func (s *ServerInterceptorTestSuite) SetupSuite() {
	...
	customServerMetrics.EnableHandlingTimeHistogram()
