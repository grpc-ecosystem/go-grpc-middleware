...
func (c *testServiceClient) PingClientStream(ctx context.Context, opts ...grpc.CallOption) (TestService_PingClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[2], TestService_PingClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *testServicePingClientStreamClient) Send(m *PingClientStreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *testServicePingClientStreamClient) CloseAndRecv() (*PingClientStreamResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (UnimplementedTestServiceServer) PingClientStream(TestService_PingClientStreamServer) error {
...
func (x *testServicePingClientStreamServer) SendAndClose(m *PingClientStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *testServicePingClientStreamServer) Recv() (*PingClientStreamRequest, error) {
