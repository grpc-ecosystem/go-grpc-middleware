...
type InterceptorTestSuite struct {
	...
	TestService testvalidatev1.TestValidateServiceServer
	...
	Client         testvalidatev1.TestValidateServiceClient
	...
	go func() {
		for {
			...
			if s.TestService == nil {
				s.TestService = &TestValidateService{}
			}
			testvalidatev1.RegisterTestValidateServiceServer(s.Server, s.TestService)
...
func (s *InterceptorTestSuite) NewClient(dialOpts ...grpc.DialOption) testvalidatev1.TestValidateServiceClient {
	...
	return testvalidatev1.NewTestValidateServiceClient(s.clientConn)
}
